...
/****** Object:  StoredProcedure [dbo].[sp_tempForecasting]    Script Date: 1/18/2019 4:13:07 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[sp_tempForecasting]
AS
BEGIn
...
set  @query = '
if not exists (select 1 from temp24 where DateT='''+Replace(@name,' ','')+''')
Begin
